<%-- 
    ...
    Created on : 12-jul-2012, 16:00:29
    Author     : jorge.correa
--%>
     ...
     if ((strNombre == null) || (strAccion == null)) {
        response.sendRedirect("cerrar.jsp");
         ...
         if (strAccion.equals("V")){
            strDatosTipos = GestionSQL.getFila("select tv.txtIdentificacion as Id, tv.txtNombre as Nombre from users_tipos_vivienda tv where tv.txtIdentificacion = '" + strCodigo +"'");
        }
     }           
%>
<html>
    <head>        
        ...
        <link rel="stylesheet" type="text/css" href="../Styles/StylesTiposVivienda.css" />
        ...
        <script type="text/javascript" charset="UTF-8" src="../Scripts/JSTiposVivienda.js"></script>
        <title>Administración de Usuarios: Gestión de Tipos de Vivienda</title>
    </head>
        ...
        <div align="center">
            ...
            <% if (strAccion.equals("C")){%>
                <table cellspacing="0" cellpadding="0" width="800px" border="0">
                    <tr>
                        <td class="TITULOFORM">NUEVO REGISTRO DE TIPO DE VIVIENDA</td>
                    </tr>                
                    <tr>
                        <td>
                            <form method="POST" action="Registro" id="frmTipoVivienda" name="frmTipoVivienda">
                                <input type="hidden" name="txtForm" id="txtForm" value="frmTipoVivienda">
                                ...
                                <table cellspacing="0" cellpadding="5" width="800px" border="0" class="TABLAHEAD">
                                    ...
                                    <tr><td colspan="4" class="CELDABOTONFORM"><input type="button" value="Guardar" class="BOTONFORM" onclick="validarFormTipoVivienda()">&nbsp;&nbsp;<input type="button" value="Limpiar" class="BOTONFORM" onclick="limpiarFormTipoVivienda()"> &nbsp;&nbsp;<input type="button" value="Salir" class="BOTONFORM" onclick="javascript:window.close();"></td></tr>
            ...
            <%}else{%>
                <table cellspacing="0" cellpadding="0" width="800px" border="0">
                    <tr>
                        <td class="TITULOFORM">REGISTRO DE TIPO DE VIVIENDA</td>
                    </tr>                
                    <tr>
                        <td>
                            <form method="POST" action="Registro" id="frmTipoVivienda" name="frmTipoVivienda">
                                ...
                                <table cellspacing="0" cellpadding="5" width="800px" border="0" class="TABLAHEAD">
                                    ...
                                    <% if (strAccion.equals("C")){%>
                                        <tr><td colspan="4" class="CELDABOTONFORM"><input type="button" value="Guardar" class="BOTONFORM" onclick="validarFormTipoVivienda()">&nbsp;&nbsp;<input type="button" value="Limpiar" class="BOTONFORM" onclick="limpiarFormTipoVivienda()"> &nbsp;&nbsp;<input type="button" value="Salir" class="BOTONFORM" onclick="javascript:window.close();"></td></tr>
                                    <%}else{%>
                                        <tr><td colspan="4" class="CELDABOTONFORM"><input type="button" value="Guardar" class="BOTONFORM" onclick="validarFormTipoVivienda()">&nbsp;&nbsp;<input type="button" value="Salir" class="BOTONFORM" onclick="javascript:window.close();"></td></tr>
                                    <%}%>                                        
                                    <tr><td colspan="4" class="MSGAVISOOBLG">Los campos marcados con (*) son obligatorios.</td></tr>                                    
                                </table>
                            </form>
