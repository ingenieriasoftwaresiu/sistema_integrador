...
<% 
    ...
    String[] strTemp = null;
     ...
     if ((strNombre == null) || (strAccion == null)) {
        ...
        Vector arrServicios = GestionSQL.consultaSQL("select s.txtCodigo as Id, s.txtNombre as Nombre from users_servicios s ORDER BY s.txtNombre","MAESTROS");
...
<html>
    <head>        
        ...
        <script type="text/javascript" charset="UTF-8" src="../Scripts/JSServiciosXResp.js"></script>
        <title>Administración: Gestión de Servicios por Responsable</title>
    </head>
        ...
        <div align="center">
            ...
            <% if (strAccion.equals("C")){%>
                <table cellspacing="0" cellpadding="0" width="800px" border="0">
                    <tr>
                        <td class="TITULOFORM">NUEVO REGISTRO DE SERVICIO POR RESPONSABLE</td>
                    </tr>                
                    <tr>
                        <td>
                            <form method="POST" action="Registro" id="frmServicioXResp" name="frmServicioXResp">
                                <input type="hidden" name="txtForm" id="txtForm" value="frmServicioXResp">
                                ...
                                <table cellspacing="0" cellpadding="5" width="800px" border="0" class="TABLAHEAD">
                                    ...
                                    <tr>
                                        <td class="LABELFORM">* Servicio:</td>
                                        <td class="CELDACAMPOFORM">
                                            <select name="txtServicio" id="txtServicio" class="CAMPOFORM" onclick="ocultarDIV()" style="width: 230px;">
                                    ...
                                    <tr><td colspan="4" class="CELDABOTONFORM"><input type="button" value="Guardar" class="BOTONFORM" onclick="validarFormServicioXResp()">&nbsp;&nbsp;<input type="button" value="Limpiar" class="BOTONFORM" onclick="limpiarFormServicioXResp()"> &nbsp;&nbsp;<input type="button" value="Salir" class="BOTONFORM" onclick="javascript:window.close();"></td></tr>
